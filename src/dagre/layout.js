...
function runLayout(g, timefn) {
  timefn("    makeSpaceForEdgeLabels", () => {
    makeSpaceForEdgeLabels(g);
  });
  timefn("    removeSelfEdges", () => {
    removeSelfEdges(g);
  });
  timefn("    acyclic", () => {
    acyclic.run(g);
  });
  timefn("    nestingGraph.run", () => {
    nestingGraph.run(g);
  });
  timefn("    rank", () => {
    rank(asNonCompoundGraph(g));
  });
  timefn("    injectEdgeLabelProxies", () => {
    injectEdgeLabelProxies(g);
  });
  timefn("    removeEmptyRanks", () => {
    removeEmptyRanks(g);
  });
  timefn("    nestingGraph.cleanup", () => {
    nestingGraph.cleanup(g);
  });
  timefn("    normalizeRanks", () => {
    normalizeRanks(g);
  });
  timefn("    assignRankMinMax", () => {
    assignRankMinMax(g);
  });
  timefn("    removeEdgeLabelProxies", () => {
    removeEdgeLabelProxies(g);
  });
  timefn("    normalize.run", () => {
    normalize.run(g);
  });
  timefn("    parentDummyChains", () => {
    parentDummyChains(g);
  });
  timefn("    addBorderSegments", () => {
    addBorderSegments(g);
  });
  timefn("    order", () => {
    order(g);
  });
  timefn("    insertSelfEdges", () => {
    insertSelfEdges(g);
  });
  timefn("    adjustCoordinateSystem", () => {
    coordinateSystem.adjust(g);
  });
  timefn("    position", () => {
    position(g);
  });
  timefn("    positionSelfEdges", () => {
    positionSelfEdges(g);
  });
  timefn("    removeBorderNodes", () => {
    removeBorderNodes(g);
  });
  timefn("    normalize.undo", () => {
    normalize.undo(g);
  });
  timefn("    fixupEdgeLabelCoords", () => {
    fixupEdgeLabelCoords(g);
  });
  timefn("    undoCoordinateSystem", () => {
    coordinateSystem.undo(g);
  });
  timefn("    translateGraph", () => {
    translateGraph(g);
  });
  timefn("    assignNodeIntersects", () => {
    assignNodeIntersects(g);
  });
  timefn("    reversePoints", () => {
